data:[{
      id9: "This package includes the global command",
    }]
{data.map((item)=>(
                      {item.id9}
                    ))}
                    ...
                    <div className=" relative bg-white mx-10 borders">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <div className="-mr-2 -my-2 md:hidden -mr-2 -my-2 md:hidden">
            <button
              type="button"
